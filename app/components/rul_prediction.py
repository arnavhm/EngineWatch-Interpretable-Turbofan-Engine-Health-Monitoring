...
def render_rul_prediction(df: pd.DataFrame):
    ...
    # evaluation_metrics is keyed like {"gradient_boosting": {"rmse": ..., "nasa_score": ...}, ...}
    model_name = type(model).__name__  # e.g. "GradientBoostingRegressor"
    ...
    if predicted_rul > 80:
        rul_color = COLORS["Healthy"]
    elif predicted_rul > 30:
        rul_color = COLORS["Degrading"]
    else:
        rul_color = COLORS["Critical"]
