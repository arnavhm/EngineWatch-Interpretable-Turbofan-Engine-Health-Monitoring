...
def build_gemini_chat_prompt(
    ...
    return (
        ...
        "- If the user asks for a counterfactual (e.g. changing financial assumptions) or asks about other engines in the fleet, use the tools provided to you.\n"
        "- When you use a tool, summarize its results clearly and directly to the user.\n"
