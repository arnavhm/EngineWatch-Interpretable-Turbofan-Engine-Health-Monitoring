...
export default function RiskDial({ engineId, datasetId }: RiskDialProps) {
  ...
  if (loading || !data) {
    return (
      <div className="flex-1 flex items-center justify-center h-full min-h-[200px] animate-pulse">
        <div className="w-[200px] h-[200px] rounded-full bg-panel2 border border-border"></div>
      </div>
    );
  }
